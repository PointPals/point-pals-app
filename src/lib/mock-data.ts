...
export const INITIAL_CHORES: Chore[] = [
  ...
  { id: "c2",  name: "Brushed teeth (AM)",   icon: "i01", color: "butter", points: 1, recurrence: "daily" },
  { id: "c3",  name: "Brushed teeth (PM)",   icon: "i02", color: "lilac",  points: 1, recurrence: "daily" },
  ...
  { id: "c7",  name: "Packed school bag",    icon: "i06", color: "sky",    points: 2, recurrence: "daily" },
  { id: "c8",  name: "Read 20 minutes",      icon: "i12", color: "lilac",  points: 3, recurrence: "daily" },
  ...
  { id: "c11", name: "Watered plants",       icon: "i18", color: "butter", points: 2, recurrence: "weekly"},
  { id: "c12", name: "Folded laundry",       icon: "i15", color: "blush",  points: 3, recurrence: "weekly"},
  { id: "c13", name: "Emptied dishwasher",   icon: "i35", color: "sand",   points: 2, recurrence: "weekly"},
  { id: "c14", name: "Took out rubbish",     icon: "i14", color: "sky",    points: 2, recurrence: "weekly"},
  { id: "c15", name: "Vacuumed a room",      icon: "i22", color: "blush",  points: 3, recurrence: "weekly"},
];
...
export const INITIAL_SKILLS: Skill[] = [
  ...
  { id: "n4", name: "Not telling truth", icon: "i59", color: "lilac", points: -2, isPositive: false },
  { id: "n5", name: "Name-calling",      icon: "i56", color: "foam",  points: -1, isPositive: false },
];


export const COMPANIONS: Companion[] = [
  { id: "sunny",   name: "Sunny",   trait: "Kindness",     color: "butter", symbol: "☀️", bodyShape: "dumpling", unlockAt: 10 },
  { id: "bramble", name: "Bramble", trait: "Bravery",      color: "sage",   symbol: "⭐", bodyShape: "pear",     unlockAt: 30 },
  { id: "pip",     name: "Pip",     trait: "Honesty",      color: "sky",    symbol: "📖", bodyShape: "egg",      unlockAt: 55 },
  { id: "marlow",  name: "Marlow",  trait: "Helping",      color: "blush",  symbol: "🤝", bodyShape: "dumpling", unlockAt: 85 },
  { id: "coda",    name: "Coda",    trait: "Independence", color: "lilac",  symbol: "👣", bodyShape: "pear",     unlockAt: 120 },
  { id: "fern",    name: "Fern",    trait: "Gratitude",    color: "foam",   symbol: "🌿", bodyShape: "dumpling", unlockAt: 160 },
  { id: "ziggy",   name: "Ziggy",   trait: "Creativity",   color: "sand",   symbol: "🎨", bodyShape: "egg",      unlockAt: 210 },
  { id: "ridge",   name: "Ridge",   trait: "Perseverance", color: "sky",    symbol: "⛰️", bodyShape: "dumpling", unlockAt: 275 },
];
...
export const INITIAL_HISTORY: PointEvent[] = [
  { id: "e1", kidId: "k1", itemName: "Read 20 minutes",    itemIcon: "i12", points: 3, at: Date.now() - 1000 * 60 * 12 },
  { id: "e2", kidId: "k2", itemName: "Brushed teeth (PM)", itemIcon: "i02", points: 1, at: Date.now() - 1000 * 60 * 45 },
  { id: "e3", kidId: "k3", itemName: "Being Kind",         itemIcon: "i45", points: 2, at: Date.now() - 1000 * 60 * 90 },
];
